...
public class XReactFragment extends Fragment implements PermissionAwareActivity {
	 ...
	 */
	private static XReactFragment newInstance(@NonNull String componentName, Bundle launchOptions) {
		XReactFragment fragment = new XReactFragment();
	...
	/**
	 * Builder class to help instantiate a {@link XReactFragment}
	 */
	public static class Builder {
		...
		/**
		 * Returns new Builder for creating a {@link XReactFragment}
		 *
		...
		public XReactFragment build() {
			return XReactFragment.newInstance(mComponentName, mLaunchOptions);
		}
